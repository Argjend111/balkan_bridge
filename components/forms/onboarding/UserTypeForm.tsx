    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid gap-4 ">
                ...
                variant="outline" className="w-full cursor-pointer h-auto p-6 items-center gap-4 border-2 transition-all duration-200 hover:border-primary hover:bg-primary/5">
                    <div className="size-12 round-full bg-primary/10 flex items-center justify-center">
                    ...
                    <div className="text-left">
                        ...
                        <p>Find your dream job oppurtinity</p>
                    </div>
                </Button>
            </div>
        </div>
